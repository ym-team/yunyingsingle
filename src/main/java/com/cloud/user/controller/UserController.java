...
public class UserController {
     ...
     * 当前登录用户 LoginAppUser
     */
    @GetMapping("/api-u/users/current")
    public LoginAppUser getLoginAppUser() {
        return AppUserUtil.getLoginAppUser();
    }

    @GetMapping(value = "/api-u/users-anon/internal", params = "username")
     ...
     * @param appUser
     */
    @PostMapping("/api-u/users-anon/register")
    ...
    @PutMapping(value = "/api-u/users/password", params = {"oldPassword", "newPassword"})
    ...
    @PutMapping(value = "/api-u/users/{id}/password", params = {"newPassword"})
    ...
    @PostMapping("/api-u/users/{id}/roles")
    ...
    @GetMapping("/api-u/users/{id}/roles")
 ...
 //   private SmsClient smsClient;
    ...
    @PostMapping(value = "/api-u/users/binding-phone")
    public void bindingPhone(String phone, String key, String code) {
        ...
        String value = phone;
        System.out.println("我把smsClient注释掉了");
        if (value == null) {
