...
//import com.cloud.backend.util.AppUserUtil;
import com.cloud.user.model.AppUser;
import com.cloud.util.Mail;
import com.cloud.util.MailStatus;
...
public class MailServiceImpl implements MailService {
    ...
    public void saveMail(Mail mail) {
        if (mail.getUserId() == null || StringUtils.isBlank(mail.getUsername())) {
            ...
            AppUser appUser = new AppUser();//AppUserUtil.getLoginAppUser();
            appUser.setUsername("张三");
