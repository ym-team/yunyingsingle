 ...
 //   @Autowired
   // private StringRedisTemplate stringRedisTemplate;
    ...
    //    String value = (String) stringRedisTemplate.boundHashOps(CACHE_CLIENT_KEY).get(clientId);
        String value = (String) map.get(CACHE_CLIENT_KEY).get(clientId);
    ...
    private ClientDetails cacheAndGetClient(String clientId) {
        ...
        if (clientDetails != null) {// 写入redis缓存
           ...
           mapE.put(clientId, JSONObject.toJSONString(clientDetails));
           map.put(CACHE_CLIENT_KEY, mapE);
...
/*    private void removeRedisCache(String clientId) {
    ...
    private void removeRedisCache(String clientId) {
        map.get(CACHE_CLIENT_KEY).remove(clientId);
    }
...
/*    public void loadAllClientToCache() {
    ...
    */
    ...
    public void loadAllClientToCache() {
        if(map.containsKey(CACHE_CLIENT_KEY)){
        	return;
        }
        ...
        list.parallelStream().forEach(client -> {
        	...
        	mapEn.put(client.getClientId(), JSONObject.toJSONString(client));
        	map.put(CACHE_CLIENT_KEY, mapEn);
        });
    }
