...
import com.cloud.notification.controller.SmsController;
...
public class UserDetailServiceImpl implements UserDetailsService {
   ...
   // private SmsClient smsClient;
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        LoginAppUser loginAppUser = userController.findByUsername(username);
    ...
    private void handlerWechatLogin(LoginAppUser loginAppUser, String[] params) {
      ...
      //  wechatController.wechatLoginCheck(tempCode, openid);
        System.out.println("我注释掉微信登录");
    ...
    private void handlerPhoneSmsLogin(LoginAppUser loginAppUser, String[] params) {
        ...
        String value = smsController.matcheCodeAndGetPhone(key, code, false, 30);
