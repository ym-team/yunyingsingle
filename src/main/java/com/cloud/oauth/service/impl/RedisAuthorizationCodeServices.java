...
public class RedisAuthorizationCodeServices extends RandomValueAuthorizationCodeServices {
	...
	private HashMap<String, OAuth2Authentication> map = new HashMap<String,OAuth2Authentication>();
	...
	protected OAuth2Authentication remove(String code) {
		...
		System.out.println("redis改为map");
		return map.remove(codeKey(code));
	}
	...
	protected void store(String code, OAuth2Authentication oAuth2Authentication) {
		// TODO Auto-generated method stub
		System.out.println("redis改成map2");
		System.out.println("没加过期时间");
		map.put(codeKey(code), oAuth2Authentication);
...
/*	@Autowired
	...
	*//**
	...
	protected OAuth2Authentication remove(final String code) {
		OAuth2Authentication oAuth2Authentication = redisTemplate.execute(
				new RedisCallback<OAuth2Authentication>() {
